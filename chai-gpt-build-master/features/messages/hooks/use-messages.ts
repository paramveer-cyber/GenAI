...
import { createMessage, deleteMessage, deleteMessagesFrom, listMessages, updateMessage } from "../actions/messages-action";
...
/**
 * Deletes a message and everything after it in the conversation.
 * Called before regenerating an assistant reply or resending an edited message.
 */
export function useDeleteMessagesFrom(conversationId: string) {
  return useMutation({
